(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~modules-about-about-module~modules-home-home-module"],{

/***/ "2OzF":
/*!*************************************************************************************!*\
  !*** ./src/app/ui/product-item/product-item/product-card/product-card.component.ts ***!
  \*************************************************************************************/
...
const _c0 = function (a0) { return [a0, "RUB", "symbol", "0.0", "ru"]; };
function ProductCardComponent_div_13_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBindV"](2, 1, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](7, _c0, ctx_r0.product.oldPrice)), " ");
} }
class ProductCardComponent {
    constructor() { }
    ngOnInit() {
        this.ribbonContent = this.product.isHit ? 'Хит' : this.product.isNew ? 'New' : `-${this.product.discount}%`;
    }
}
ProductCardComponent.ɵfac = function ProductCardComponent_Factory(t) { return new (t || ProductCardComponent)(); };
ProductCardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProductCardComponent, selectors: [["app-product-card"]], inputs: { view: "view", orientation: "orientation", product: "product" }, decls: 19, vars: 19, consts: [[1, "card"], [1, "ribbon"], [1, "img-container"], ["alt", "1", "src", "../../../../../assets/dev/product.png"], [1, "img-substrate"], [1, "card-body"], [1, "category"], [1, "name"], [1, "buy"], [1, "pricing"], ["class", "old-price", 4, "ngIf"], [1, "price"], [1, "buy-button"], [1, "old-price"]], template: function ProductCardComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](13, ProductCardComponent_div_13_Template, 3, 9, "div", 10);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](18, " \u041A\u0443\u043F\u0438\u0442\u044C ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵclassProp"]("hit", ctx.product.isHit)("new", ctx.product.isNew)("discount", ctx.product.discount > 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", ctx.ribbonContent, " ");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.product.discount > 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBindV"](16, 11, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](17, _c0, ctx.product.price)), " ");
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["NgIf"]], pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CurrencyPipe"]], styles: ["[_nghost-%COMP%] {\n  font-family: \"Ruble\", \"Proxima Nova Rg\", serif;\n}\n\n.hit[_ngcontent-%COMP%]   .price[_ngcontent-%COMP%] {\n  color: #16b267;\n}\n\n.hit[_ngcontent-%COMP%]   .ribbon[_ngcontent-%COMP%] {\n  background-color: #16b267;\n}\n\n.hit[_ngcontent-%COMP%]   .ribbon[_ngcontent-%COMP%]::before {\n  border-color: #16b267;\n  border-left-width: 10px;\n  border-left-color: rgba(255, 255, 255, 0);\n}\n\n.new[_ngcontent-%COMP%]   .price[_ngcontent-%COMP%] {\n  color: #ff6101;\n}\n\n.new[_ngcontent-%COMP%]   .ribbon[_ngcontent-%COMP%] {\n  background-color: #ff6101;\n}\n\n.new[_ngcontent-%COMP%]   .ribbon[_ngcontent-%COMP%]::before {\n  border-color: #ff6101;\n  border-left-width: 10px;\n  border-left-color: rgba(255, 255, 255, 0);\n}\n\n.discount[_ngcontent-%COMP%]   .price[_ngcontent-%COMP%] {\n  color: #ffa200;\n}\n\n.discount[_ngcontent-%COMP%]   .ribbon[_ngcontent-%COMP%] {\n  background-color: #ffa200;\n}\n\n.discount[_ngcontent-%COMP%]   .ribbon[_ngcontent-%COMP%]::before {\n  border-color: #ffa200;\n  border-left-width: 10px;\n  border-left-color: rgba(255, 255, 255, 0);\n}\n\n.card[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-end;\n  height: 100%;\n  width: 100%;\n  padding: 20px;\n  position: relative;\n}\n\n.pricing[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  flex-wrap: wrap;\n}\n\n.price[_ngcontent-%COMP%] {\n  color: #ffffff;\n  font-size: 18px;\n}\n\n.old-price[_ngcontent-%COMP%] {\n  color: rgba(255, 255, 255, 0.36);\n  font-size: 15px;\n  text-decoration: line-through;\n  margin-right: 10px;\n}\n\n.buy[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  margin-top: 15px;\n  align-items: center;\n}\n\n.category[_ngcontent-%COMP%] {\n  font-size: 12px;\n  font-family: \"Proxima Nova Rg\", serif;\n  color: #ffffff;\n  padding: 7px 11px;\n  border-radius: 3px;\n  background-color: #193161;\n  align-self: flex-start;\n  text-transform: uppercase;\n}\n\n.name[_ngcontent-%COMP%] {\n  margin-top: 12px;\n  font-size: 18px;\n  color: #ffffff;\n}\n\n.buy-button[_ngcontent-%COMP%] {\n  font-size: 16px;\n  border-radius: 20px;\n  border: solid 1px #3faae7;\n  padding: 10px 20px;\n  color: #3faae7;\n}\n\n.card-body[_ngcontent-%COMP%] {\n  z-index: 2;\n  display: flex;\n  flex-direction: column;\n}\n\n.img-container[_ngcontent-%COMP%] {\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  overflow: hidden;\n  top: 0;\n  left: 0;\n  z-index: 0;\n  border-radius: 5px;\n}\n\n.img-container[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  z-index: 0;\n}\n\n.img-substrate[_ngcontent-%COMP%] {\n  z-index: 1;\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background: linear-gradient(0deg, black 0%, rgba(255, 255, 255, 0) 80%);\n}\n\n.ribbon[_ngcontent-%COMP%] {\n  transform: rotate(-90deg);\n  top: 6px;\n  left: 15px;\n  text-transform: uppercase;\n  position: absolute;\n  z-index: 3;\n  font-size: 14px;\n  color: #ffffff;\n  padding-right: 6px;\n  text-align: right;\n  width: 40px;\n  height: 28px;\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n}\n\n.ribbon[_ngcontent-%COMP%]::before {\n  content: \"\";\n  display: block;\n  left: -3px;\n  position: relative;\n  border-style: solid;\n  border-right-width: 8px;\n  border-top-width: 14px;\n  border-bottom-width: 14px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
/***/ "2bCQ":
/*!************************************************************************!*\
  !*** ./src/app/ui/product-item/product-item/product-item.component.ts ***!
  \************************************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _product_line_product_line_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./product-line/product-line.component */ "DzgJ");
/* harmony import */ var _product_card_product_card_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./product-card/product-card.component */ "2OzF");
...
function ProductItemComponent_ng_container_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](1, "app-product-line");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();
} }
function ProductItemComponent_ng_template_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-product-card", 2);
} if (rf & 2) {
    const ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("view", ctx_r2.view)("orientation", ctx_r2.orientation)("product", ctx_r2.product);
} }
...
ProductItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProductItemComponent, selectors: [["app-product-item"]], inputs: { view: "view", orientation: "orientation", product: "product" }, decls: 3, vars: 2, consts: [[4, "ngIf", "ngIfElse"], ["cardBlock", ""], [3, "view", "orientation", "product"]], template: function ProductItemComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, ProductItemComponent_ng_container_0_Template, 2, 0, "ng-container", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, ProductItemComponent_ng_template_1_Template, 1, 3, "ng-template", null, 1, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplateRefExtractor"]);
    } if (rf & 2) {
        const _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.view == "Line")("ngIfElse", _r1);
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["NgIf"], _product_line_product_line_component__WEBPACK_IMPORTED_MODULE_2__["ProductLineComponent"], _product_card_product_card_component__WEBPACK_IMPORTED_MODULE_3__["ProductCardComponent"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3VpL3Byb2R1Y3QtaXRlbS9wcm9kdWN0LWl0ZW0vcHJvZHVjdC1pdGVtLmNvbXBvbmVudC5zY3NzIn0= */"] });
...
/***/ "DzgJ":
/*!*************************************************************************************!*\
  !*** ./src/app/ui/product-item/product-item/product-line/product-line.component.ts ***!
  \*************************************************************************************/
...
class ProductLineComponent {
    constructor() { }
    ngOnInit() {
    }
}
ProductLineComponent.ɵfac = function ProductLineComponent_Factory(t) { return new (t || ProductLineComponent)(); };
ProductLineComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProductLineComponent, selectors: [["app-product-line"]], decls: 2, vars: 0, template: function ProductLineComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "product-line works!");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } }, styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3VpL3Byb2R1Y3QtaXRlbS9wcm9kdWN0LWl0ZW0vcHJvZHVjdC1saW5lL3Byb2R1Y3QtbGluZS5jb21wb25lbnQuc2NzcyJ9 */"] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProductLineComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
/***/ "UrEr":
/*!********************************************************!*\
  !*** ./src/app/ui/product-item/product-item.module.ts ***!
  \********************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProductItemModule", function() { return ProductItemModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _product_item_product_item_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./product-item/product-item.component */ "2bCQ");
/* harmony import */ var _product_item_product_card_product_card_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./product-item/product-card/product-card.component */ "2OzF");
/* harmony import */ var _product_item_product_line_product_line_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./product-item/product-line/product-line.component */ "DzgJ");
...
ProductItemModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: ProductItemModule });
ProductItemModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function ProductItemModule_Factory(t) { return new (t || ProductItemModule)(); }, imports: [[
            _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"]
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ProductItemModule, { declarations: [_product_item_product_item_component__WEBPACK_IMPORTED_MODULE_2__["ProductItemComponent"], _product_item_product_card_product_card_component__WEBPACK_IMPORTED_MODULE_3__["ProductCardComponent"], _product_item_product_line_product_line_component__WEBPACK_IMPORTED_MODULE_4__["ProductLineComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"]], exports: [_product_item_product_item_component__WEBPACK_IMPORTED_MODULE_2__["ProductItemComponent"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProductItemModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
                declarations: [_product_item_product_item_component__WEBPACK_IMPORTED_MODULE_2__["ProductItemComponent"], _product_item_product_card_product_card_component__WEBPACK_IMPORTED_MODULE_3__["ProductCardComponent"], _product_item_product_line_product_line_component__WEBPACK_IMPORTED_MODULE_4__["ProductLineComponent"]],
                exports: [
...
class Product {
    constructor({ category, name, price, image, discount, isNew, isHit }) {
        this.category = category;
        this.name = name;
        this.price = discount > 0 ? price * (100 - discount) / 100 : price;
        this.oldPrice = price;
        this.image = image;
...
//# sourceMappingURL=default~modules-about-about-module~modules-home-home-module.js.map